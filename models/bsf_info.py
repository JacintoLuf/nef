...
class BsfInfo(Model):
    ...
    """
    def __init__(self, dnn_list: List[str]=None, ip_domain_list: List[str]=None, ipv4_address_ranges: List[Ipv4AddressRange]=None, ipv6_prefix_ranges: List[Ipv6PrefixRange]=None):  # noqa: E501
        """BsfInfo - a model defined in Swagger
    ...
    @property
    def ip_domain_list(self) -> List[str]:
    ...
    def ip_domain_list(self, ip_domain_list: List[str]):
