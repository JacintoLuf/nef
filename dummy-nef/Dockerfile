...
#HTTP2/ server
#CMD ["hypercorn", "--bind", "0.0.0.0:7777", "--keyfile", "key.pem", "--certfile", "cert.pem", "main:app"]
CMD ["hypercorn", "--bind", "0.0.0.0:7777", "--worker-class", "asyncio", "main:app"]
#, "--config", "api/hypercorn_config.py"
