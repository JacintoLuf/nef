...
from models.all_of_plmn_snssai_s_nssai_list_items import AllOfPlmnSnssaiSNssaiListItems  # noqa: F401,E501
import util
...
class PlmnSnssai(Model):
    ...
    """
    def __init__(self, plmn_id: NFProfilePlmnList=None, s_nssai_list: List[AllOfPlmnSnssaiSNssaiListItems]=None, nid: str=None):  # noqa: E501
        """PlmnSnssai - a model defined in Swagger
        ...
        :type s_nssai_list: List[AllOfPlmnSnssaiSNssaiListItems]
    ...
    @property
    def s_nssai_list(self) -> List[AllOfPlmnSnssaiSNssaiListItems]:
        """Gets the s_nssai_list of this PlmnSnssai.


        :return: The s_nssai_list of this PlmnSnssai.
        :rtype: List[AllOfPlmnSnssaiSNssaiListItems]
        """
        return self._s_nssai_list

    @s_nssai_list.setter
    def s_nssai_list(self, s_nssai_list: List[AllOfPlmnSnssaiSNssaiListItems]):
