...
class VendorSpecificFeature(Model):
    ...
    """
    def __init__(self, feature_name: str=None, feature_version: str=None):  # noqa: E501
        """VendorSpecificFeature - a model defined in Swagger
    ...
    def feature_version(self, feature_version: str):
