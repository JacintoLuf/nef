...
class RouteInformation(Model):
    ...
    """
    def __init__(self, ipv4_addr: Ipv4Addr=None, ipv6_addr: Ipv6Addr=None, port_number: Uinteger=None):  # noqa: E501
    ...
    @port_number.setter
    def port_number(self, port_number: Uinteger):
