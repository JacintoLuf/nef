...
class Ecgi1(Model):
    ...
    def __init__(self, plmn_id=None, eutra_cell_id=None, nid=None):  # noqa: E501
        """Ecgi1 - a model defined in OpenAPI

        :param plmn_id: The plmn_id of this Ecgi1.  # noqa: E501
        :type plmn_id: PlmnId1
        :param eutra_cell_id: The eutra_cell_id of this Ecgi1.  # noqa: E501
        :type eutra_cell_id: str
        :param nid: The nid of this Ecgi1.  # noqa: E501
        :type nid: str
        """
        self.openapi_types = {
            'plmn_id': PlmnId1,
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'Ecgi1':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The Ecgi_1 of this Ecgi1.  # noqa: E501
        :rtype: Ecgi1
        """
    ...
    @property
    def plmn_id(self):
        """Gets the plmn_id of this Ecgi1.


        :return: The plmn_id of this Ecgi1.
        :rtype: PlmnId1
        """
    ...
    def plmn_id(self, plmn_id):
        """Sets the plmn_id of this Ecgi1.


        :param plmn_id: The plmn_id of this Ecgi1.
        :type plmn_id: PlmnId1
        """
        if plmn_id is None:
    ...
    def eutra_cell_id(self):
        """Gets the eutra_cell_id of this Ecgi1.
        ...
        :return: The eutra_cell_id of this Ecgi1.
        :rtype: str
        """
    ...
    def eutra_cell_id(self, eutra_cell_id):
        """Sets the eutra_cell_id of this Ecgi1.

        28-bit string identifying an E-UTRA Cell Id as specified in clause 9.3.1.9 of  3GPP TS 38.413, in hexadecimal representation. Each character in the string shall take a  value of \"0\" to \"9\", \"a\" to \"f\" or \"A\" to \"F\" and shall represent 4 bits. The most  significant character representing the 4 most significant bits of the Cell Id shall appear  first in the string, and the character representing the 4 least significant bit of the  Cell Id shall appear last in the string.    # noqa: E501

        :param eutra_cell_id: The eutra_cell_id of this Ecgi1.
        :type eutra_cell_id: str
        """
    ...
    @nid.setter
    def nid(self, nid):
        """Sets the nid of this Ecgi1.

        This represents the Network Identifier, which together with a PLMN ID is used to identify an SNPN (see 3GPP TS 23.003 and 3GPP TS 23.501 clause 5.30.2.1).    # noqa: E501

        :param nid: The nid of this Ecgi1.
        :type nid: str
        """
