...
class NfServiceSetCond(Model):
    ...
    """
    def __init__(self, nf_service_set_id: str=None):  # noqa: E501
        """NfServiceSetCond - a model defined in Swagger
    ...
    @property
    def nf_service_set_id(self) -> str:
    ...
    def nf_service_set_id(self, nf_service_set_id: str):
