...
class Tai1(Model):
    ...
    def __init__(self, plmn_id=None, tac=None, nid=None):  # noqa: E501
        ...
        :param plmn_id: The plmn_id of this Tai1.  # noqa: E501
        :type plmn_id: PlmnId1
        :param tac: The tac of this Tai1.  # noqa: E501
        :type tac: str
        :param nid: The nid of this Tai1.  # noqa: E501
        :type nid: str
        """
        self.openapi_types = {
            'plmn_id': PlmnId1,
    ...
    @property
    def plmn_id(self):
        """Gets the plmn_id of this Tai1.


        :return: The plmn_id of this Tai1.
        :rtype: PlmnId1
        """
    ...
    def plmn_id(self, plmn_id):
        """Sets the plmn_id of this Tai1.


        :param plmn_id: The plmn_id of this Tai1.
        :type plmn_id: PlmnId1
        """
        if plmn_id is None:
    ...
    @nid.setter
    def nid(self, nid):
        """Sets the nid of this Tai1.

        This represents the Network Identifier, which together with a PLMN ID is used to identify an SNPN (see 3GPP TS 23.003 and 3GPP TS 23.501 clause 5.30.2.1).    # noqa: E501

        :param nid: The nid of this Tai1.
        :type nid: str
        """
