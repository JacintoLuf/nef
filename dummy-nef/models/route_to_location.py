...
from models.route_information import RouteInformation  # noqa: F401,E501
import util
...
class RouteToLocation(Model):
    ...
    """
    def __init__(self, dnai: Dnai=None, route_info: RouteInformation=None, route_prof_id: str=None):  # noqa: E501
    ...
    @property
    def route_info(self) -> RouteInformation:
    ...
    @route_info.setter
    def route_info(self, route_info: RouteInformation):
    ...
    def route_prof_id(self, route_prof_id: str):
