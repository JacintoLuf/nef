...
class NfGroupCond(Model):
    ...
    """
    def __init__(self, nf_type: str=None, nf_group_id: str=None):  # noqa: E501
        """NfGroupCond - a model defined in Swagger
    ...
    def nf_type(self, nf_type: str):
        ...
        :type nf_type: str
        """
        allowed_values = ["UDM", "AUSF", "UDR", "PCF", "CHF"]  # noqa: E501
    ...
    @nf_group_id.setter
    def nf_group_id(self, nf_group_id: str):
