...
class IdleStatusIndication(Model):
    ...
    """
    def __init__(self, time_stamp: datetime=None, active_time: int=None, subs_reg_timer: int=None, edrx_cycle_length: int=None, suggested_num_of_dl_packets: int=None):  # noqa: E501
        """IdleStatusIndication - a model defined in Swagger
    ...
    @active_time.setter
    def active_time(self, active_time: int):
    ...
    def subs_reg_timer(self, subs_reg_timer: int):
    ...
    @property
    def edrx_cycle_length(self) -> int:
    ...
    def edrx_cycle_length(self, edrx_cycle_length: int):
    ...
    @property
    def suggested_num_of_dl_packets(self) -> int:
    ...
    def suggested_num_of_dl_packets(self, suggested_num_of_dl_packets: int):
