...
class AmfEventSubscriptionInfo(Model):
    ...
    """
    def __init__(self, sub_id: str=None, notify_correlation_id: str=None, ref_id_list: List[int]=None, old_sub_id: str=None):  # noqa: E501
        """AmfEventSubscriptionInfo - a model defined in Swagger
    ...
    @ref_id_list.setter
    def ref_id_list(self, ref_id_list: List[int]):
    ...
    @old_sub_id.setter
    def old_sub_id(self, old_sub_id: str):
