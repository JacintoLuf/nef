...
from models.access_state_transition_type import AccessStateTransitionType  # noqa: F401,E501
import util
...
class UeAccessBehaviorReportItem(Model):
    ...
    """
    def __init__(self, state_transition_type: AccessStateTransitionType=None, spacing: int=None, duration: int=None):  # noqa: E501
        """UeAccessBehaviorReportItem - a model defined in Swagger
    ...
    @property
    def state_transition_type(self) -> AccessStateTransitionType:
    ...
    def state_transition_type(self, state_transition_type: AccessStateTransitionType):
